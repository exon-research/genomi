...
OPERATIONS: list[Operation] = [
    ...
    Operation('protein.retrieve_reference_sequence', _protein_retrieve_reference_sequence),
    ...
    Operation('lab.create_information_gap', _lab_create_information_gap),
    Operation('lab.revise_information_gap', _lab_revise_information_gap),
