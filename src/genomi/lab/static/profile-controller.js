...
export function createProfileController({state, refresh}) {
  ...
  function handleManageGenomeHandoff() {
    showAlert(
      "Genomi owns genome setup and updates. In your installed assistant, ask: “Manage the current Genomi user’s genome.” Return here afterward and use Compare latest profile in any affected inquiry.",
      "success"
    );
