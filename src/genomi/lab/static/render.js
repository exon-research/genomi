...
export function renderInvestigation(investigation, harnessManifest = {}, observations = []) {
  document.body.dataset.workspaceView = "inquiry";
...
export function closeInvestigation() {
  document.body.dataset.workspaceView = "overview";
...
export function renderContextCandidate(candidate, observations = []) {
  ...
  elements.contextPreviewPurpose.textContent = `Purpose: ${text(candidate.purpose) || "Use this context only for this investigation."}`;
  const definitions = [];
